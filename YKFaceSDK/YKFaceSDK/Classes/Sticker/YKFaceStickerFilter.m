...
@implementation YKFaceStickerFilter {
...
- (void)setFaceInfoArray:(NSArray<YKFaceInfo *> *)faceInfoArray {
    runAsynchronouslyOnVideoProcessingQueue(^{
...
- (void)renderToTextureWithVertices:(const GLfloat *)vertices textureCoordinates:(const GLfloat *)textureCoordinates {
    ...
    if (self.faceInfoArray.count) {
        ...
        if (self.faceInfoArray && self.faceInfoArray.count > 0) {
            NSInteger i = 0;
            for (YKFaceInfo *faceInfo in self.faceInfoArray) {
                [_sticker drawItemsWithFace:faceInfo
                                  faceIndex:i
