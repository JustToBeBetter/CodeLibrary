...
@implementation GetNetWorkSpeed

static GetNetWorkSpeed* instance = nil;
...

{
    ...
    if (_iBytes != 0) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:DownloadNetworkSpeedNotificationKey object:nil];
    ...
    if (_oBytes != 0) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:UploadNetworkSpeedNotificationKey object:nil];
