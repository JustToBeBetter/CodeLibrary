...
@implementation LJZRecordEncoder

+ (LJZRecordEncoder*)encoderForPath:(NSString*) path Height:(NSInteger) cy width:(NSInteger) cx channels: (int) ch samples:(Float64) rate{
    LJZRecordEncoder* enc = [LJZRecordEncoder alloc];
...
- (CGAffineTransform)transformFromCurrentVideoOrientationToOrientation:(AVCaptureVideoOrientation)orientation
{
    ...
    CGFloat videoOrientationAngleOffset = [self angleOffsetFromPortraitOrientationToOrientation:[LJZMotionManager sharedManager].videoOrientation];
