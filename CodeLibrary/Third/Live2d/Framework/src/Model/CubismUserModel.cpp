...
CubismMotionManager* CubismUserModel::GetExpressionManager() const
{
    return _expressionManager;
}
CubismMotionManager* CubismUserModel::GetMotionManager() const
{
    return _motionManager;
}
CubismTargetPoint* CubismUserModel::GetDragManager() const
{
    return _dragManager;
}
